---
title: "Hydrodynamical mass-loss rates for Very Massive Stars. II. New theoretical mass-loss predictions at solar metallicity (Z = 0.02)"
collection: publications
category: manuscripts
permalink: /publication/2026-07-01-hydrodynamical-massloss-rates-ii
excerpt: 'This work presents the largest grid to date of hydrodynamically consistent wind-atmosphere models, covering a wide range of stellar parameters relevant to O and WNh stars. We independently confirm an upturn in the mass-loss rate as the wind transitions from optically thin to optically thick, where photons undergo multiple interactions with spectral lines and, on average, transfer momentum to the wind more than once before escaping. The predicted mass-loss rates, terminal wind velocities, and ionising photon flux counts can be used in stellar-evolution models and to study the mechanical and ionising feedback from massive and very massive stars in young clusters.'
date: 2026-07-01
